...
<head>
    ...
    <title>
        <?php echo $__env->yieldContent('title', $settings->store_name ?? 'سوبر ماركت'); ?>
    </title>
            ...
            <div class="min-h-[76px] flex items-center gap-4">
                ...
                >
                    ...
                    <img
                        ...
                        alt="<?php echo e($settings->store_name ?? 'سوبر ماركت'); ?>"
                    ...
                    <span class="hidden sm:block text-lg md:text-xl font-bold text-slate-900 whitespace-nowrap">
                        <?php echo e($settings->store_name ?? 'سوبر ماركت'); ?>
...
[$__name, $__params] = $__split('search-products', []);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-155247773-0', $__key);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-155247773-1', $__key);
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="text-center">
                ...
                <p class="text-sm text-slate-400">
                    &copy; <?php echo e(date('Y')); ?> سوبر ماركت الباشا
                    <br>
                    تطوير وبرمجة:
...
<?php /**PATH C:\Users\ea084\Desktop\supermarket\resources\views/layouts/app.blade.php ENDPATH**/ ?>